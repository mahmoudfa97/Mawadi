    ...
    <div className="py-5 z-50">
      <header className="w-[96%] main-header xl:w-[92%] duration-100 ease-in-out top-0 bg-white relative z-50 mx-auto rounded-full shadow-md ">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="hidden md:flex space-x-6 arabicMenu">
            <Link to="/" className="mx-5 text-gray-700 hover:text-gray-900 transition">
              {" "}
              {isArabic ? "بيت" : "Home"}
            </Link>
            <Link to="/bestsellers" className="text-gray-700 hover:text-gray-900 transition">
              {" "}
              {isArabic ? "الأكثر مبيعا" : "Best seller"}
            </Link>
            <Link to="/categories" className="text-gray-700 hover:text-gray-900 transition" onMouseEnter={() => handleDropDOwn()} onMouseLeave={() => setHoveredCategory(null)}>
              {" "}
            ...
            <Link
              ...
              onMouseEnter={() => setHoveredCategory("مناسبات")}
              onMouseLeave={() => setHoveredCategory(null)}
            >
              {" "}
              {isArabic ? "مناسبات" : "Occasions"}
            </Link>
            <Link to="/mawaddi-magic" className="text-gray-700 hover:text-gray-900 transition">
              {" "}
              {isArabic ? "سحر مودة " : "Mawadi-Magic"}
            </Link>
          </nav>
