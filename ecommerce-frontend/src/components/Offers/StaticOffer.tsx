// StaticOffer.tsx
// Purpose: Renders a list of static offers available to users.
// Main Functionalities:
// - Displays a heading for available offers.
// - Lists multiple offers with descriptions, including icons for visual representation.
